---
title: "QC - Stem cells Trisomy 21 & Euploids"
...
```{r}
selected_samples <- colData(se) %>% as.data.frame() %>% tibble::rownames_to_column(var = "sample_id") %>% dplyr::filter(class == "Trisomy21_stemcell" | class == "Euploid_stemcell")
...
### Top 700 variable genes (totalReads)
...
We can observe that there's not much difference between Trisomy21 and Euploid samples.
